        ...
        <div className="w-full max-w-[490px] rounded-[20px] xs:rounded-[25px] sm:rounded-[32px] border border-[#1C265A] bg-[#09112E]/60 backdrop-blur-xl p-5 xs:p-6 sm:p-8 lg:p-10 text-center">
          ...
          <div className="flex flex-col xs:flex-row justify-center gap-2 xs:gap-3">
            ...
            <button
              ...
              className="px-4 xs:px-6 py-2 xs:py-3 rounded-lg xs:rounded-xl border border-[#1C265A] bg-[#0B1025]/40 backdrop-blur-xl text-white text-sm xs:text-base font-semibold hover:border-cyan-400 transition-colors duration-300"
            >
              Ro'yxatdan o'tish
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] lg:grid-cols-[340px_1fr] gap-4 xs:gap-5 sm:gap-6 lg:gap-5">
        ...
        <div data-aos="fade-up-right" className="rounded-[20px] xs:rounded-[25px] sm:rounded-[28px] lg:rounded-[32px] border border-[#1C265A] bg-[#09112E]/60 backdrop-blur-xl p-4 xs:p-5 sm:p-6 lg:p-7">
          ...
          {!user.name &&
            <button
              onClick={() => navigate("/register")}
              className="mt-3 xs:mt-4 w-full px-4 xs:px-5 py-2 xs:py-3 rounded-lg xs:rounded-xl bg-gradient-to-r from-purple-600 to-cyan-500 text-white text-sm xs:text-base font-semibold hover:scale-105 transition-transform duration-300"
            >
              Ro'yxatdan o'tish
            </button>
          }
